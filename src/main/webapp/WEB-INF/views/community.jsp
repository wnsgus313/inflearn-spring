...
<body>
<%@ page import="com.inflearn.dao.QuestionDao, com.inflearn.beans.*, java.util.*" %>
    ...
    <div class="container">
        <div class="navbar">
            ...
            <div class="navbar-items">
                ...
                <a class="navbar-item" href="/questions">커뮤니티</a>
            ...
            <table class="board-table">
                ...
                <c:forEach items="${list}" var="q" varStatus='status'>
	                <tr>
	                    <td>${status.count}</td>
	                    <th>
	                      <a href="question/${q.getId()}">${q.getTitle()}</a>
	                    </th>
	                    <td>${q.getTime_stamp()}</td>
	                </tr>
	            </c:forEach>
                </tbody>
            </table>
